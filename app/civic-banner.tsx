...
export default function CivicBanner({onMap}:{onMap:()=>void}){
 ...
 return <section className="civic-banner" aria-labelledby="civic-banner-title">
  ...
  <div className="civic-copy">
   ...
   <div className="civic-actions"><button className="button civic-primary" onClick={explore}><MapPin size={18}/><span>Find projects <small lang="hi">परियोजनाएँ खोजें</small></span><ArrowRight size={17}/></button><button className="button civic-secondary" onClick={onMap}><ShieldCheck size={18}/><span>Explore risk map <small lang="hi">निगरानी मानचित्र</small></span><ArrowRight size={17}/></button></div>
  </div>
